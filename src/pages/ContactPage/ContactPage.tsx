  ...
  return (
    <div className=" w-full items-center mb-20">
      <div className="grid grid-cols-2">
        <div className="image-container h-fit  flex flex-col items-center justify-center">
          <img
        ...
        <div className=" flex flex-col items-center gap-6 justify-center">
          <h1 className="w-fit">
            <span className="bg-[#FE7062] text-[#1B262C] font-bold px-2 rounded-md ">
              Contact
            </span>{" "}
            us
          </h1>
          ...
          >
            ...
            <div className="flex justify-center mt-12">
              ...
              <button
                className="w-1/3 bg-[#4244E6] text-black font-bold hover:text-white"
                type="submit"
              >
                Contact Now
              </button>
